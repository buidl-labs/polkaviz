...
class CalculatorForm extends React.Component {
	render() {
		...
		return (
			<Box>
				<Stat mt={4} p={4} textAlign="center" backgroundColor="tomato" borderRadius={4}>
					<StatLabel>Earn upto</StatLabel>
					<StatNumber>{maxReward === 0 ? "0" : maxReward} DOTs</StatNumber>
					<StatHelpText>for {stakeAmount} DOT(s) stake</StatHelpText>
				</Stat>
				<Stack mt={8} spacing={6} direction="horizontal">
					<FormControl flexGrow={1}>
						<FormLabel htmlFor="stakeAmount">Stake Amount (in DOTs)</FormLabel>
						<Input
							name="stakeAmount"
